...
var JSAnimation = prime({
    ...
    step: function(now){
        ...
        this.set(tpl)
        if (factor !== 1) sixty.push(this.bstep)
...
var CSSAnimation = prime({
    ...
    setTransitionStyles: function(inclusive){
