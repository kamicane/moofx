...
var BrowserAnimation = function BrowserAnimation(node, property){
...
var JSAnimation = inherits(BrowserAnimation, function JSAnimation(node, property){
...
JSAnimation.prototype.start = function(to){
	...
	if (prepared){
		...
		if (fromN[0].length !== toN[0].length) throw new Error("length mismatch")
		this.from = fromN[0]
		this.to = toN[0]
		this.template = toN[1]
...
var CSSAnimation = inherits(BrowserAnimation, function CSSAnimation(node, property){
	this.parent.constructor.call(this, node, property)
